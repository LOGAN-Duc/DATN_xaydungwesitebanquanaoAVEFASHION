										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="quantity" type="number" min="1" class="form-control" id="quantity" name="quantity" placeholder="quantity of product"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="price" min="0" type="number" autocomplete="off" id="price" name="price" class="form-control" placeholder="price"></sf:input>
                                        		</div>
	                                    	</div>
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="sale_price" min="0" type="number" autocomplete="off" id="salePrice" name="salePrice" class="form-control" placeholder="Sale price"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:textarea path="short_description" id="shortDescription" name="shortDescription"
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:textarea path="detail_description" id="detailDescription" name="detailDescription"
										...
										<div class="row">
	                        		 		<div class="col-md-2">
												<div class="form-group mb-4">
													...
													<sf:checkbox path="is_hot" class="form-check-input" id="isHot" name="isHot"></sf:checkbox>
